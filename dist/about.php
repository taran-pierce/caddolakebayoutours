...
<html lang="en">
  <?php
    $title = "About Us - Caddo Lake Bayou Tours";
    $canonical = "/about";
  ...
  <body>
    ...
    <div class="container body-content">
      ...
      <section class="hero">
        <img class="img-responsive" src="images/lake-mirror-1-banner.jpg" alt="Cypress trees" />
      </section>
      <section>
        <div class="container">
          <div class="row">
            ...
            <div class="col-xs-12 col-md-6">
              <div class="img-container">
                <img src="images/june/large/13.jpg" class="img-responsive" alt="Caddo Lake Cypress Trees" />
              </div>
            </div>
          </div>
        </div>
      ...
      <section>
        <div class="container">
          <div class="row">
            <div class="col-xs-12 col-sm-6">
              <div class="img-container">
                <img class="img-responsive" src="images/june/large/12.jpg" alt="Caddo Lake Bald Cypress Trees" />
              </div>
            </div>
            <div class="col-xs-12 col-md-6">
            ...
            <ul class="list-unstyled">
              <li>
                ...
                <p>A member of the crocodile family, the American alligator is a living fossil from the Age of Reptiles, having survived on earth for 200 million years.</p>
                <p><a href="https://www.fws.gov/refuge/Caddo_Lake/wildlife/alligator.html" target="_blank" rel="noopener">More info here.</a></p>
              </li>
              <li>
                <h5><strong>Paddlefish</strong></h5>
