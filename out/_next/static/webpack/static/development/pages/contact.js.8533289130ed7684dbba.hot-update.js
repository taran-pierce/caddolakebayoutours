...
var Form = function Form(props) {
  ...
  if (!sent) {
    ...
    return __jsx("section", {
      ...
      __self: this
    }, _textData && _textData.titles && _textData.titles.map(function (title, index) {
      return __jsx("div", {
        key: index,
    ...
    }), _textData && _textData.paragraphs && _textData.paragraphs.map(function (paragraph, index) {
      return __jsx("p", {
        key: index,
        dangerouslySetInnerHTML: {
          __html: paragraph
    ...
    }), _textData && _textData.lists && _textData.lists.map(function (list, index) {
      return __jsx("ul", {
        key: index,
        __source: {
          fileName: _jsxFileName,
...
//# sourceMappingURL=contact.js.8533289130ed7684dbba.hot-update.js.map