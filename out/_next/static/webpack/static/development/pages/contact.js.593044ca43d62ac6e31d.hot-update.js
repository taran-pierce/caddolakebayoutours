  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(Page, [{
    ...
    value: function render() {
      ...
      var formData = {
        ...
        textData: [{
          titles: ['<h1>Contact Caddo Lake Bayou Tours</h1>', '<h3>Rich McFarland <strong>Tour Guide</strong></h3>'],
          paragraphs: ['Tours available 7 days a week, any time from sunrise to sunset. Boat tours last approximately one hour.', 'Make sure to like us on <a href="https://www.facebook.com/caddotours/" target="_blank">FaceBook</a>', '<strong>Book a boat tour or send a message</strong>', 'Ask about boat tour reservations, fishing trips, availability of dates or times, or any other general questions.'] // lists: [
          //   {
          //     'type': 'ul',
          //     'items': [
          //       {
...
//# sourceMappingURL=contact.js.593044ca43d62ac6e31d.hot-update.js.map