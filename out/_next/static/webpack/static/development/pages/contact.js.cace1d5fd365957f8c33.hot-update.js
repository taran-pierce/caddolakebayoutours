...
var Form = function Form(props) {
  ...
  if (!sent) {
    ...
    return __jsx("section", {
      ...
      __self: this
    }, test && test.titles && test.titles.map(function (title, index) {
      return __jsx("div", {
        key: index,
    ...
    }), test && test.paragraphs && test.paragraphs.map(function (paragraph, index) {
      return __jsx("p", {
        key: index,
        dangerouslySetInnerHTML: {
          __html: paragraph
    ...
    }), test && test.lists && test.lists.map(function (list, index) {
      return __jsx("ul", {
        key: index,
        __source: {
          fileName: _jsxFileName,
...
//# sourceMappingURL=contact.js.cace1d5fd365957f8c33.hot-update.js.map