...
var sideHug8 = {
  ...
  imageFirst: true,
  textData: [{
    titles: ['<h2>Riverbend Outfitters</h2>'],
    paragraphs: ['If you are looking to control the speed of your tour of the lake then you should definately check out Riverbend Outfitters!', 'They can set you up with Kayaks or canoes so that you can move about the lake at your own pace to explore.', '<a href="https://riverbendoutfitters.com/" target="_blank" rel="noopener">Check out their site</a>']
  }]
};
var sideHug9 = {
  image: {
  ...
  textData: [{
    titles: ['<h2>TravelAwaits - things near Jefferson Texas</h2>'],
    paragraphs: ['Fantastic blog about travel that features places from around the world.', 'There are plenty of articles about Texas in general, but there is also an article specifically about things to do near Jefferson.', 'Caddo Lake Bayou Tours is excited to say that we were mentioned in their article (item 7) as one of the great things that you should do while visiting.', 'Please check out the full article by click the link down below!', '<a href="https://www.travelawaits.com/2552685/outdoor-activities-near-jefferson-texas/" target="_blank" rel="noopener">View Article</a>']
  }]
};
